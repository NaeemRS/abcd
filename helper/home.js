export const headerData = [
    {
        ...
        title: "Book Your Designated Driver",
        description: "Call +971 52 894 8931 or Whatsapp and let us know when and where you want the Driver to pick you up from, or book online and we'll call you back to confirm your booking."
    },
    {
        id: 'fa6-regular:handshake',
        title: "Meet Your Designated Driver",
...
export const GetOurSober1 = ({
    ...
    law abiding and will always refrain to drive under the influence of alcohol.
     As per the article no.10.6. any driver who is found guilty will be prosecuted 
     and a penalty in terms of fine, imprisonment and/or a minimum fine of AED 25,000
      as per the article no 49.6 of the traffic law.
    Our drivers have years of experience and are highly skilled.
...
export const servicesCardData = [
    {
        ...
        items1: "Business Trips", 
        items2: "Conferences",
        items3:  "Leisure Trips"
    },
    {
        category: "Airport Trips",
        items1: "Arrivals", 
        items2: "Departures",
        items3:  "Hotel Transfer"
    },
    {
...
export const faqsData1 = [
    {
        ...
        key: '1',
        title: 'What is safe driver service?',
        content: 'A safe driver service is a service, which provides drivers to the people who cannot drive to the physical conditions or other road conditions.'
    },
    {

        key: '2',
        title: 'What are the costs to book a safe driver in Dubai?',
        content: 'Hiring a safe driver with in Dubai city limits AED 80 only, and from Dubai to Sharjah it is AED 150.'
    },
    {
...

    {
        ...
        key: '4',
        title: 'how long can the driver wait after reaching the pickup point?',
        content: 'Our Drivers will wait for a maximum of 10 mins and if the wait time exceeds 10 mins the booking will be automatically canceled. The cancellation will be charged a fee of AED 15.'
    },
    {

        key: '5',
        title: 'What should i do if the driver does not arrive on time?',
        content: 'This is highly unlikely, however, if it happens you can contact the assigned driver or contact us immediately if the driver does not arrive within 30 minutes from the time of acceptance of your trip.'
    },
    {
...
export const faqsData2 =[
     {
        key: '7',
        title: 'How to Book a Safe Driver in Dubai?',
        content: 'Customers can call +971 52 894 8931 to book a driver in Dubai or can book online through our website.'
    },
    {
        key: '8',
        title: 'What are Your Working Hours?',
        content: 'Our drivers are available 24/7 at your service. Call anytime anywhere in Dubai at +971 52 894 8931.'
    },
    {
        key: '9',
        title: 'Can the Driver Drive Me to Multiple Stops?',
        content: 'Yes. Our drivers will take you anywhere and stop at multiple locations as per your requirement.'
    },
    {
        key: '10',
        title: 'What is Your Cancellation Policy?',
        content: 'Customers can request to cancel a driver 90 minutes prior to the scheduled pickup time.'
    },
    {
        key: '11',
    ...
    {
        key: '12',
        title: 'How Can I Trust the Drivers?',
        content: 'Our drivers are registered with Dubai’s Roads and Transport Authority (RTA) and undergo a rigorous screening process. This includes police clearance, RTA Permit card, professionalism, and extensive driving experience in UAE. They strictly follow the traffic laws of UAE and have experience in driving all types of vehicles, ensuring your car is in safe hands.'
    }
...
export const awesomeDriveBenefits = [
    ...
    {
      description: 'Ensure a safe journey in the comfort of your own car, driven by our professional driver.'
    },
    {
      description: 'Protect your health by avoiding public transport, especially important during times of pandemic.'
    },
    {
