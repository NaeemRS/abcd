...
const CallToBook = () => {
    return (
        ...
        <img src='/images/safe-driver-dubai.jpg' className='w-full h-full absolute object-cover left-0 right-0' />
            <div className="max-w-[85rem] mx-auto relative text-center py-8 px-6">
                <div className='flex flex-col items-center justify-center h-full max-w-lg rounded mx-auto px-3 lg:px-10 py-5 bg-[#000000a1]'>
                <h2 className="md:text-2xl text-xl font-bold mb-3">CALL US TO BOOK A SAFE DRIVER</h2>
