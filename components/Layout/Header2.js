            ...
            <div className="flex flex-wrap items-center justify-between w-full md:py-0">
              ...
              >
                <ul className="relative pt-4 text-white navbar-nav-div md:pt-0">
                  ...
                  <li>
                    <Link className="block py-2 md:p-4 " href="/contact-us">
                      <div
                        className={`w-full text-center whitespace-nowrap cursor-pointer text-sm hover:yellow  ${router.asPath === "/contact-us" && "redClr "
                          } `}
                        onClick={toggleMenu}
                      >
                        BOOK NOW
